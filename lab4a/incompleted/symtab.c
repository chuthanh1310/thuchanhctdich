...
}//return 1: type1 = type2, neu khong return 0
...
}//Kieu Int vaf Char thi chi can free btg, kieu Array thi free kieu gia tri lan gia tri kich co

/******************* Constant utility ******************************/
//Cac ham tao kieu Hang so
